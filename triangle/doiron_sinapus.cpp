...
void calv(double *v,double *u,double *s,double *s_egp,double *A_egp,double *V_s, double *n_s,double *V_d,double *h_d, double *n_d,double *p_d,  int *spike_s,int *spike_d, double *inp, double t,int *spikecnt_s,int *spikecnt_d,int *count_s,int *count_d,double *THl,FILE *fp1,FILE *fp2,FILE *fp3,FILE *fp4,FILE *fp5,FILE *fp6,FILE *fp7)
{
  ...
  for(int i=0;i<NUM;i++){
    ...
    */
    if(	0	<t<	100	){	inp[i]=I0* ( (	1	 +t*	0.000000000000 	) *  exp( -( (i-(	47.69277	 +t*	0.000000000000 	))*(i-(	47.69277	 +t*	0.000000000000 	))) / (2*(	23.4093	 +t*	0.000000000000 	 )*(	23.4093	 +t*	0.000000000000 	) ))); }
    if(	100	<t<	200	){	inp[i]=I0* ( (	0.982939035	 +t*	-0.000001706096 	) *  exp( -( (i-(	49.38084	 +t*	0.000168807000 	))*(i-(	49.38084	 +t*	0.000168807000 	))) / (2*(	26.50258	 +t*	0.000309328000 	 )*(	26.50258	 +t*	0.000309328000 	) ))); }
    if(	200	<t<	300	){	inp[i]=I0* ( (	0.999545041	 +t*	0.000001660601 	) *  exp( -( (i-(	48.91876	 +t*	-0.000046208000 	))*(i-(	48.91876	 +t*	-0.000046208000 	))) / (2*(	27.2436	 +t*	0.000074102000 	 )*(	27.2436	 +t*	0.000074102000 	) ))); }
    if(	300	<t<	400	){	inp[i]=I0* ( (	0.981346679	 +t*	-0.000001819836 	) *  exp( -( (i-(	48.56338	 +t*	-0.000035538000 	))*(i-(	48.56338	 +t*	-0.000035538000 	))) / (2*(	24.36694	 +t*	-0.000287666000 	 )*(	24.36694	 +t*	-0.000287666000 	) ))); }
    if(	400	<t<	500	){	inp[i]=I0* ( (	0.952229299	 +t*	-0.000002911738 	) *  exp( -( (i-(	46.38368	 +t*	-0.000217970000 	))*(i-(	46.38368	 +t*	-0.000217970000 	))) / (2*(	23.0359	 +t*	-0.000133104000 	 )*(	23.0359	 +t*	-0.000133104000 	) ))); }
    if(	500	<t<	600	){	inp[i]=I0* ( (	0.977024568	 +t*	0.000002479527 	) *  exp( -( (i-(	45.69522	 +t*	-0.000068846000 	))*(i-(	45.69522	 +t*	-0.000068846000 	))) / (2*(	23.58759	 +t*	0.000055169000 	 )*(	23.58759	 +t*	0.000055169000 	) ))); }
    if(	600	<t<	700	){	inp[i]=I0* ( (	0	 +t*	-0.000097702457 	) *  exp( -( (i-(	0	 +t*	-0.004569522000 	))*(i-(	0	 +t*	-0.004569522000 	))) / (2*(	0	 +t*	-0.002358759000 	 )*(	0	 +t*	-0.002358759000 	) ))); }
    if(	700	<t<	800	){	inp[i]=I0* ( (	0.924249318	 +t*	0.000092424932 	) *  exp( -( (i-(	41.61367	 +t*	0.004161367000 	))*(i-(	41.61367	 +t*	0.004161367000 	))) / (2*(	25.50855	 +t*	0.002550855000 	 )*(	25.50855	 +t*	0.002550855000 	) ))); }
    if(	800	<t<	900	){	inp[i]=I0* ( (	0.909463148	 +t*	-0.000001478617 	) *  exp( -( (i-(	41.15174	 +t*	-0.000046193000 	))*(i-(	41.15174	 +t*	-0.000046193000 	))) / (2*(	27.76699	 +t*	0.000225844000 	 )*(	27.76699	 +t*	0.000225844000 	) ))); }
    if(	900	<t<	1000	){	inp[i]=I0* ( (	0.869881711	 +t*	-0.000003958144 	) *  exp( -( (i-(	36.84341	 +t*	-0.000430833000 	))*(i-(	36.84341	 +t*	-0.000430833000 	))) / (2*(	27.97097	 +t*	0.000020398000 	 )*(	27.97097	 +t*	0.000020398000 	) ))); }
    if(	1000	<t<	1100	){	inp[i]=I0* ( (	0.861692448	 +t*	-0.000000818926 	) *  exp( -( (i-(	35.84879	 +t*	-0.000099462000 	))*(i-(	35.84879	 +t*	-0.000099462000 	))) / (2*(	26.62877	 +t*	-0.000134220000 	 )*(	26.62877	 +t*	-0.000134220000 	) ))); }
    if(	1100	<t<	1200	){	inp[i]=I0* ( (	0.814604186	 +t*	-0.000004708826 	) *  exp( -( (i-(	33.50837	 +t*	-0.000234042000 	))*(i-(	33.50837	 +t*	-0.000234042000 	))) / (2*(	27.8527	 +t*	0.000122393000 	 )*(	27.8527	 +t*	0.000122393000 	) ))); }
    if(	1200	<t<	1300	){	inp[i]=I0* ( (	1.621701547	 +t*	0.000080709736 	) *  exp( -( (i-(	28.29178	 +t*	-0.000521659000 	))*(i-(	28.29178	 +t*	-0.000521659000 	))) / (2*(	18.50414	 +t*	-0.000934856000 	 )*(	18.50414	 +t*	-0.000934856000 	) ))); }
    if(	1300	<t<	1400	){	inp[i]=I0* ( (	0.763193813	 +t*	-0.000085850773 	) *  exp( -( (i-(	30.76049	 +t*	0.000246871000 	))*(i-(	30.76049	 +t*	0.000246871000 	))) / (2*(	24.68098	 +t*	0.000617684000 	 )*(	24.68098	 +t*	0.000617684000 	) ))); }
    if(	1400	<t<	1500	){	inp[i]=I0* ( (	0.716105551	 +t*	-0.000004708826 	) *  exp( -( (i-(	28.13071	 +t*	-0.000262978000 	))*(i-(	28.13071	 +t*	-0.000262978000 	))) / (2*(	27.68557	 +t*	0.000300459000 	 )*(	27.68557	 +t*	0.000300459000 	) ))); }
    if(	1500	<t<	1600	){	inp[i]=I0* ( (	0.670837125	 +t*	-0.000004526843 	) *  exp( -( (i-(	27.21307	 +t*	-0.000091764000 	))*(i-(	27.21307	 +t*	-0.000091764000 	))) / (2*(	31.46205	 +t*	0.000377648000 	 )*(	31.46205	 +t*	0.000377648000 	) ))); }
    if(	1600	<t<	1700	){	inp[i]=I0* ( (	0.624203822	 +t*	-0.000004663330 	) *  exp( -( (i-(	26.16911	 +t*	-0.000104396000 	))*(i-(	26.16911	 +t*	-0.000104396000 	))) / (2*(	32.65031	 +t*	0.000118826000 	 )*(	32.65031	 +t*	0.000118826000 	) ))); }
    if(	1700	<t<	1800	){	inp[i]=I0* ( (	0.583257507	 +t*	-0.000004094631 	) *  exp( -( (i-(	27.49416	 +t*	0.000132505000 	))*(i-(	27.49416	 +t*	0.000132505000 	))) / (2*(	34.11608	 +t*	0.000146577000 	 )*(	34.11608	 +t*	0.000146577000 	) ))); }
    if(	1800	<t<	1900	){	inp[i]=I0* ( (	1.026387625	 +t*	0.000044313012 	) *  exp( -( (i-(	23.31769	 +t*	-0.000417647000 	))*(i-(	23.31769	 +t*	-0.000417647000 	))) / (2*(	30.80132	 +t*	-0.000331476000 	 )*(	30.80132	 +t*	-0.000331476000 	) ))); }
    if(	1900	<t<	2000	){	inp[i]=I0* ( (	0.57233849	 +t*	-0.000045404914 	) *  exp( -( (i-(	33.11001	 +t*	0.000979232000 	))*(i-(	33.11001	 +t*	0.000979232000 	))) / (2*(	34.79955	 +t*	0.000399823000 	 )*(	34.79955	 +t*	0.000399823000 	) ))); }
    if(	2000	<t<	2100	){	inp[i]=I0* ( (	0.575068244	 +t*	0.000000272975 	) *  exp( -( (i-(	38.26434	 +t*	0.000515433000 	))*(i-(	38.26434	 +t*	0.000515433000 	))) / (2*(	32.58507	 +t*	-0.000221448000 	 )*(	32.58507	 +t*	-0.000221448000 	) ))); }
    if(	2100	<t<	2200	){	inp[i]=I0* ( (	0.610100091	 +t*	0.000003503185 	) *  exp( -( (i-(	43.40053	 +t*	0.000513619000 	))*(i-(	43.40053	 +t*	0.000513619000 	))) / (2*(	32.7223	 +t*	0.000013723000 	 )*(	32.7223	 +t*	0.000013723000 	) ))); }
    if(	2200	<t<	2300	){	inp[i]=I0* ( (	0.708371247	 +t*	0.000009827116 	) *  exp( -( (i-(	47.26221	 +t*	0.000386168000 	))*(i-(	47.26221	 +t*	0.000386168000 	))) / (2*(	28.54399	 +t*	-0.000417831000 	 )*(	28.54399	 +t*	-0.000417831000 	) ))); }
    if(	2300	<t<	2400	){	inp[i]=I0* ( (	0.826205641	 +t*	0.000011783439 	) *  exp( -( (i-(	49.17341	 +t*	0.000191120000 	))*(i-(	49.17341	 +t*	0.000191120000 	))) / (2*(	27.40751	 +t*	-0.000113648000 	 )*(	27.40751	 +t*	-0.000113648000 	) ))); }
    if(	2400	<t<	2500	){	inp[i]=I0* ( (	1	 +t*	0.000017379436 	) *  exp( -( (i-(	47.69277	 +t*	-0.000148064000 	))*(i-(	47.69277	 +t*	-0.000148064000 	))) / (2*(	23.4093	 +t*	-0.000399821000 	 )*(	23.4093	 +t*	-0.000399821000 	) ))); }
